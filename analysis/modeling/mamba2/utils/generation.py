...
def decode(
    ...
    # print(f"[decode] {cg = }, {eos_token_id = }, {max_length = }")
    ...
    def get_logits(input_ids, inference_params):
        ...
        pred = logits.argmax(dim=-1).cpu().detach()
        # print(f"[get_logits] {pred = }")
    ...
    def should_stop(current_token, inference_params):
        # print(f"[should_stop] {current_token = }, {max_length = }, {eos_token_id = }, {inference_params.seqlen_offset}")
...
class GenerationMixin:
    ...
    def generate(
        ...
        **kwargs,
        ...
        # print(f"[GenerationMixin.generate] {max_length = }")
        output = decode(
            input_ids,
            model=self,
