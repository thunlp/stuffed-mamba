...
def get_pred(
    ...
    """
    Mamba-2 performs poorly when top_k != 1.
    """
    # print("Truncating...")
    # input_text = truncate_by_tokens(input_text, tok, TRUNCATE_LEN)
    if add_prefix:
        # Add a meaningless prefix. Ideally, this shouldn't affect the model's
...
def load_model(
    ...
    model = Mamba2ForCausalLM.from_pretrained(model_path).to(torch.bfloat16)
